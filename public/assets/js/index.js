$(document).ready(function() { 
    ...
    var accountNameInput = $("input#submitAccountName");
    var keywordInput = $("input#submitKeyword");

    // add EventHandlers to each of the submit buttons
    // Account name submit button
    accountNameInput.on('click', function(event) {
    ...
    submitKeyword.on('click', function(event) {
        event.preventDefault();
